              ...
              <Col md={12}>
                <FormGroup>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Smith College Libraries Logo"
                  />
                  <small className="text-muted d-block mt-1">
                    <i className="bi bi-info-circle me-1"></i>
        ...
        <Row className="mt-5">
          <Col md={12}>
            ...
            <Alert color="info" className="mb-3">
              ...
              <strong>How to use:</strong> Copy the code below and paste it into your website where you want the Gadgets to Go page to appear.
            </Alert>
          </Col>
          ...
          <Col md={12}>
            <FormGroup>
              <Label className="fw-bold d-flex justify-content-between align-items-center">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    const schoolPath = schoolMap[mapLocations] || 'smith';
                    const currentUrl = window.location.origin;
                    const embedCode = `<iframe src="${currentUrl}/gadgets-to-go/school/${schoolPath}?view=grid" width="${embedWidth}" height="${embedHeight}px" frameborder="0" scrolling="auto" title="Gadgets to Go - ${mapLocations}" style="border: 1px solid #ddd; border-radius: 8px;"></iframe>`;
              ...
              <div className="position-relative">
                <Input
                  ...
                  value={(() => {
                    ...
                    const schoolPath = schoolMap[mapLocations] || 'smith';
                    const currentUrl = window.location.origin;
                    return `<iframe src="${currentUrl}/gadgets-to-go/school/${schoolPath}?view=grid" width="${embedWidth}" height="${embedHeight}px" frameborder="0" scrolling="auto" title="Gadgets to Go - ${mapLocations}" style="border: 1px solid #ddd; border-radius: 8px;"></iframe>`;
                  })()}
              ...
              <small className="text-muted d-block mt-2">
                <i className="bi bi-info-circle me-1"></i>
                This code creates an embedded window showing your Gadgets to Go page. The page will automatically update when you make changes.
              </small>
            </FormGroup>
          </Col>
