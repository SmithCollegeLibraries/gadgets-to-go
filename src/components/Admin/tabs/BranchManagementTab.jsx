...
function BranchManagementTab({ baseUrl, token, mapLocations }) {
  ...
  const filteredBranches = currentInstitution?.branches || EMPTY_LIST;
  const filteredLocations = currentInstitution?.locations || EMPTY_LIST;
          ...
          <div className="bg-light p-3 rounded">
            ...
            <ol>
              <li>
                ...
                <ul>
                  <li>Query params: <code>owner</code> (institution code from config)</li>
              ...
              <li>
                ...
                <ul>
                  <li>Body: <code>{`{ owner: "LIB", branches: [], locations: [] }`}</code></li>
...
-- Only stores items that have been explicitly disabled`}
          ...
          <ul>
            ...
            <li>Changes are saved per configured institution</li>
