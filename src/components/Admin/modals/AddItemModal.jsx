...
const AddItemModal = ({ isOpen, toggle, baseUrl, token, mapLocations, refreshInventory, filteredBranches, locations }) => {
    // Search State
    ...
    const handleSearch = async () => {
        ...
        setIsSearching(true);
        let query = '';
        if (searchType === 'title') query = `(title all "${searchQuery}")`;
        else if (searchType === 'hrid') query = `hrid=${searchQuery}`;
